...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { attack: @weapon.attack, defense: @weapon.defense, name: @weapon.name, velocity: @weapon.velocity } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { attack: @weapon.attack, defense: @weapon.defense, name: @weapon.name, velocity: @weapon.velocity } }
