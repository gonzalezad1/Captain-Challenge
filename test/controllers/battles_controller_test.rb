...
class BattlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post battles_url, params: { battle: { firstpersonnage: @battle.firstpersonnage, recapfight: @battle.recapfight, secondpersonnage: @battle.secondpersonnage, winner: @battle.winner } }
    end
  ...
  test "should update battle" do
    patch battle_url(@battle), params: { battle: { firstpersonnage: @battle.firstpersonnage, recapfight: @battle.recapfight, secondpersonnage: @battle.secondpersonnage, winner: @battle.winner } }
